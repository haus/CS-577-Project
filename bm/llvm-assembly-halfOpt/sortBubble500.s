...
## BB#1506:
	...
	movb	$1, -16(%rax)
	.align	4, 0x90
LBB4_1507:                              ## =>This Loop Header: Depth=1
                                        ##     Child Loop BB4_1509 Depth 2
...
## BB#1508:                             ##   in Loop: Header=BB4_1507 Depth=1
	...
	movl	$1, (%rax)
	.align	4, 0x90
LBB4_1509:                              ##   Parent Loop BB4_1507 Depth=1
                                        ## =>  This Inner Loop Header: Depth=2
	movq	-2072(%rbp), %rbx       ## 8-byte Reload
	movl	(%rbx), %ebx
	cmpl	$499, %ebx              ## imm = 0x1F3
	jg	LBB4_1507
## BB#1510:                             ##   in Loop: Header=BB4_1509 Depth=2
	...
	cmpl	(%r14), %r15d
	jb	LBB4_1512
## BB#1511:                             ##   in Loop: Header=BB4_1509 Depth=2
	leaq	___unnamed_1(%rip), %rax
	movq	%rax, %rdi
	callq	__write_string
	movl	$-1, %edi
	callq	_exit
LBB4_1512:                              ##   in Loop: Header=BB4_1509 Depth=2
	movslq	%r15d, %rax
	...
	cmpl	(%r15), %r12d
	jb	LBB4_1514
## BB#1513:                             ##   in Loop: Header=BB4_1509 Depth=2
	leaq	___unnamed_1(%rip), %rax
	movq	%rax, %rdi
	callq	__write_string
	movl	$-1, %edi
	callq	_exit
LBB4_1514:                              ##   in Loop: Header=BB4_1509 Depth=2
	movslq	%r12d, %rax
	cmpl	4(%r15,%rax,4), %r14d
	jle	LBB4_1524
## BB#1515:                             ##   in Loop: Header=BB4_1509 Depth=2
	...
	cmpl	(%r14), %r15d
	jb	LBB4_1517
## BB#1516:                             ##   in Loop: Header=BB4_1509 Depth=2
	leaq	___unnamed_1(%rip), %rax
	movq	%rax, %rdi
	callq	__write_string
	movl	$-1, %edi
	callq	_exit
LBB4_1517:                              ##   in Loop: Header=BB4_1509 Depth=2
	movslq	%r15d, %rax
	...
	cmpl	(%r14), %r15d
	jb	LBB4_1519
## BB#1518:                             ##   in Loop: Header=BB4_1509 Depth=2
	leaq	___unnamed_1(%rip), %rax
	movq	%rax, %rdi
	callq	__write_string
	movl	$-1, %edi
	callq	_exit
LBB4_1519:                              ##   in Loop: Header=BB4_1509 Depth=2
	movq	-2080(%rbp), %rax       ## 8-byte Reload
	movq	(%rax), %r12
	movq	-2072(%rbp), %rax       ## 8-byte Reload
	movl	(%rax), %r13d
	...
	cmpl	(%r12), %r13d
	jb	LBB4_1521
## BB#1520:                             ##   in Loop: Header=BB4_1509 Depth=2
	leaq	___unnamed_1(%rip), %rax
	movq	%rax, %rdi
	callq	__write_string
	movl	$-1, %edi
	callq	_exit
LBB4_1521:                              ##   in Loop: Header=BB4_1509 Depth=2
	movslq	%r13d, %rax
	...
	cmpl	(%r14), %r15d
	jb	LBB4_1523
## BB#1522:                             ##   in Loop: Header=BB4_1509 Depth=2
	leaq	___unnamed_1(%rip), %rax
	movq	%rax, %rdi
	callq	__write_string
	movl	$-1, %edi
	callq	_exit
LBB4_1523:                              ##   in Loop: Header=BB4_1509 Depth=2
	movq	-2088(%rbp), %rax       ## 8-byte Reload
	movl	(%rax), %eax
	movslq	%r15d, %rcx
	movl	%eax, 4(%r14,%rcx,4)
LBB4_1524:                              ##   in Loop: Header=BB4_1509 Depth=2
	incl	%ebx
...
LBB4_1525:
	...
	jmp	LBB4_1526
	.align	4, 0x90
LBB4_1527:                              ##   in Loop: Header=BB4_1526 Depth=1
	movq	-2080(%rbp), %rax       ## 8-byte Reload
	movq	(%rax), %r12
	movq	-2072(%rbp), %rax       ## 8-byte Reload
	movl	(%rax), %r13d
	cmpl	(%r12), %r13d
	jb	LBB4_1529
## BB#1528:                             ##   in Loop: Header=BB4_1526 Depth=1
	movq	%r14, %rdi
	callq	__write_string
	movl	$-1, %edi
	callq	_exit
LBB4_1529:                              ##   in Loop: Header=BB4_1526 Depth=1
	movslq	%r13d, %rax
